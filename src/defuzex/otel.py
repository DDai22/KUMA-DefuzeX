...
from .trace_evidence import TraceEvidenceCapture, TraceEvidenceLimits
...
try:
    ...
    raise ImportError(
        'OpenTelemetry Trace Evidence requires: pip install "defuzex[otel]"'
    ) from exc
...
def configure_trace_evidence(
    ...
    *,
    ...
    returned capture to :func:`defuzex.create_run`. If no explicit provider is given,
