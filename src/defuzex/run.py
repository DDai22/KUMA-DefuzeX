...
from .tracking.evidence import EvidenceCollector, PreparedEvidence
...
class Run:
    ...
    def __init__(
        ...
        *,
        ...
        self._index = 0
        self._current: DefuzeXInput | None = None
    ...
    def get_input(self, *, full: bool = False) -> Any:
        ...
        returns the immutable :class:`DefuzeXInput` with public identifiers and
    ...
    def _submission_input(self, logs: list[str | Path] | None) -> DefuzeXInput:
