"""Authenticated, retry-safe transport for the deployed DefuzeX SDK API."""
...
def _read_response(response: Any, status: int) -> Mapping[str, Any]:
    ...
    if len(raw) > _MAX_RESPONSE_BYTES:
        raise ServiceError(
            "The DefuzeX response exceeded the SDK size limit.",
...
def _wire_transport(
    ...
    try:
        ...
        raise DefuzeTimeoutError(
            "The DefuzeX request timed out.",
        ...
        raise ServiceError(
            "The DefuzeX service could not be reached.",
            code="network_error",
            retryable=True,
        ) from exc
...
_ERROR_CLASSES: dict[str, type[DefuzeError]] = {
    ...
    "model_timeout": DefuzeTimeoutError,
...
_STATUS_CLASSES: dict[int, type[DefuzeError]] = {
    401: AuthenticationError,
    403: PermissionDeniedError,
    408: DefuzeTimeoutError,
    413: LimitExceededError,
    429: LimitExceededError,
    504: DefuzeTimeoutError,
}
_ERROR_MESSAGES = {
    AuthenticationError: "The DefuzeX API key is invalid, expired, or revoked.",
    PermissionDeniedError: "The DefuzeX API key lacks permission for this operation.",
    ServiceBusyError: "The DefuzeX service is busy; submit a new request later.",
    DefuzeTimeoutError: "The DefuzeX model request timed out.",
    ...
    LimitExceededError: "A DefuzeX service limit was exceeded.",
    SensitiveDataError: "Sensitive data was rejected by the DefuzeX service.",
    ValidationError: "The DefuzeX request was rejected as invalid.",
    ServiceError: "The DefuzeX service request failed.",
}


def _mapped_remote_error(error: _RemoteError) -> DefuzeError:
...
def encode_multipart(
    ...
    boundary = "defuzex-" + secrets.token_hex(18)
    chunks: list[bytes] = []
...
class BackendClient:
    ...
    def _headers(
        ...
        headers = {
            ...
            "User-Agent": f"defuzex-python/{__version__}",
        }
